...
<body class="easyui-layout" >
	<div region="center" border="false" style="padding:5px;">	
		<form id="updateForm" class="easyui-form" method="post" data-options="novalidate:true">
			...
			<fieldset class="fieldset_common_style">
	    		...
	    		<tr>
	    			...
	    			<tr>
		    			...
		    			<td class="table_common_td_txt_style">
		    				<input class="easyui-numberbox" precision="1" type="text" name="minYield" value="${list.minYield }" data-options="min:0,max:999999999.99,precision:2,groupSeparator:','" style="width:187px;"></input>
		    				<span class="span_common_mustinput_style">*</span>
		    			</td>
	    			</tr>
	    			<tr>
		    			...
		    			<td class="table_common_td_txt_style">
		    				<input class="easyui-numberbox" precision="1" type="text" name="maxYield" value="${list.maxYield }" data-options="min:0,max:999999999.99,precision:2,groupSeparator:','"  style="width:187px;"></input>
		    				<span class="span_common_mustinput_style">*</span>
		    			</td>
	    			</tr>
	    			<tr>
		    			...
		    			<td class="table_common_td_txt_style">
		    				<input class="easyui-numberbox" precision="2"  type="text" name="milledriceRate" value="${list.milledriceRate }" data-options="min:0,max:99999.9999,precision:2,groupSeparator:','"  style="width:187px;"></input>
		    				<span class="span_common_mustinput_style">*</span>
		    			</td>
	    			</tr>
	    			<tr height="80">
...
function save(){
	var a = $('#updateForm').toObject();
	showLoading();
	$.ajax({
		url:"${pageContext.request.contextPath}/graiEval/updateSave",
		type:"post",
		data:a,
		success:function(e){
			hideLoading();
