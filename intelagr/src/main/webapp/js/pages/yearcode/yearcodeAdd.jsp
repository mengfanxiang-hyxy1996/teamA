				...
				<table class="table_common_style">
					<tr>
		    			...
		    			<td class="table_common_td_txt_style">
		    				<input class="easyui-numberbox" id="yearCode" name="yearCode" >
	    			...
	    			<tr>
		    			...
		    			<td class="table_common_td_txt_style">
		    				<input class="easyui-textbox" id="yearName" name="yearName" >
		    				<span class="span_common_mustinput_style">*</span>
		    			</td>
	    			</tr>
	    			<tr>
...
function formCheck(){
	...
	showLoading();
	Public.ajaxPost("${pageContext.request.contextPath}/year/save",JSON.stringify(a),
		    function(e){	
			    hideLoading();
			if (200 == e.status) {
